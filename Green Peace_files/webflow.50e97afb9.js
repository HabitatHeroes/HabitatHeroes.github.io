                ...
                _.call(this, I, function (k, Y, ue) {
                  (O[k] = Y),
                    this.current[k] === void 0 &&
                      ((E = 0),
                      ~k.indexOf("scale") && (E = 1),
                      (this.current[k] = this.convert(E, ue)));
                }),
                O
              );
            });
          ...
          (l.init = function (_) {
            ...
            (l.render = function (_) {
              ...
              for (I = O; I--; )
                (E = this.tweens[I]),
                  E.context &&
                    (E.render(_), (this.current[E.name] = E.value), (k = !0));
              return k
...
` +
        ...
        function e(r) {
          ...
          function u(w) {
            var C = w.type,
              R = w.tagName;
            return !!(
              (R === "INPUT" && s[C] && !w.readOnly) ||
              (R === "TEXTAREA" && !w.readOnly) ||
              w.isContentEditable
            );
          }
          function f(w) {
  ...
  var Du = c((u5, Mu) => {
    ...
    !cn &&
      ...
      ((Be = Xi.match(/Edge\/(\d+)/)),
      (!Be || Be[1] >= 74) &&
        ((Be = Xi.match(/Chrome\/(\d+)/)), Be && (cn = +Be[1])));
    Mu.exports = cn;
  });
  var ki = c((c5, Vu) => {
    var Gu = Du(),
  ...
  function cM(e, t) {
    ...
    for (let i = 0; i < r.length; i++)
      if (!uM.call(t, r[i]) || !Bv(e[r[i]], t[r[i]])) return !1;
    return !0;
  }
  var uM,
    Ma,
  ...
  function Ba({
    ...
    if (
      (G
        ? ((B = x.limitAffectedElements), (X = Z), (W = a(x)))
        : (X = W = a({ id: m, selector: y, selectorGuids: S })),
      t && C)
    ) {
      let P = r && (W || C === !0) ? [r] : u(Z);
      if (W) {
  ...
  function Kv({ actionGroup: e, event: t, elementApi: r }) {
    ...
    n.forEach((i) => {
      ...
      wt(o)
        ? (a = (u) => Na(o)(u, i))
        : (a = iy({ effect: sD, actionTypeId: o, elementApi: r })),
  ...
  function lD(e, { basedOn: t }) {
    return (
      (e === ke.SCROLLING_IN_VIEW && (t === Je.ELEMENT || t == null)) ||
      (e === ke.MOUSE_MOVE && t === Je.ELEMENT)
    );
  }
  function fD(e, t) {
    return e + OM + t;
      ...
      (jv = /px/),
        ...
        (MM = (e, t) =>
          t.reduce(
            (r, n) => (
              r[n.type] == null &&
                (r[n.type] = WM[n.type] || n.defaultValue || 0),
              r
            ),
            e || {}
          ));
  ...
  var py,
    ...
    vy = le(() => {
      ...
      ly();
      dy();
      ({ ixElements: MD } = gy.IX2ElementsReducer),
        (DD = (0, py.combineReducers)({
          ixData: wf,
          ixRequest: zf,
          ixSession: $f,
          ixElements: MD,
  ...
  var fs = c((Cj, vm) => {
    ...
    function bV(e) {
      for (
        var t = e.name + "", r = hm[t], n = _V.call(hm, t) ? r.length : 0;
        n--;
          ...
          [vU]: {
            ...
            handler: (
              ...
              return (
                ...
                (s !== Je.ELEMENT || w || w !== o.elementHovered) &&
                  ((y = f ? 1 - y : y), e.dispatch(or(S, y))),
                {
                  elementHovered: w,
                  clientX: g,
                  clientY: d,
  ...
  function ZU(e) {
    Rt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: tB }),
      Rt({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: rB }),
      Rt({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: nB }),
      Rt({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: iB });
  }
  function JU(e) {
    Rt({
      store: e,
  ...
  function aB(e, t) {
    let r = (n) => {
      ...
      i.active &&
        (e.dispatch(ai(n, o)), t ? eB(e, r) : requestAnimationFrame(r));
    };
    ...
    if (u && u.useFirstGroupAsInitialState) {
      ...
      f.forEach((g) => {
        ...
        m.forEach((y) => {
          ...
          Ts({
            destination: _s({ element: y, actionItem: g, elementApi: xe }, S),
            immediate: !0,
            store: e,
            element: y,
            eventId: r,
        ...
        function b(y) {
          if (!y.getAttribute("hreflang")) {
            ...
            if (((a.href = S), !(S.indexOf(":") >= 0))) {
              ...
              if (!(S === "#" || S === "")) {
                var R =
                  a.href === s.href || S === d || (f.test(S) && p.test(d));
                A(w, u, R);
              }
            }
          }
...
Webflow.require("ix2").init({
  events: {
    "e-160": {
      ...
      target: {
        id: "64968f24e17f17b911fe0b4b|8ee938c5-f38b-9303-5b8c-a7beec99110e",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-162": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64968f24e17f17b911fe0b4b|65e6b3b6-7068-4bc8-7804-85b18cc4cfa4",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-164": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64968f24e17f17b911fe0b4b|e98aff13-fd4b-e09a-ad0d-93244cfb212f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-166": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64968f24e17f17b911fe0b4b|08754793-3eb5-4bce-6e65-a77768fcc6fd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-168": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "64968f24e17f17b911fe0b4b|64fe07e8-6946-ca8a-5a0e-4c783e087fc7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
    "a-2": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".image-3",
                  selectorGuids: ["badef8de-4150-190e-7a38-e06c891dc99e"],
                },
                widthValue: 0,
                heightValue: 0,
                widthUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  selector: ".button-border._1",
                  selectorGuids: [
                    "d7bcd116-2c43-4f63-ad2e-e8c7e08c50cb",
                    "7ecd877e-bb5e-41cc-b673-b34e0b09ba72",
                  ],
                },
                xValue: 0,
                yValue: 0,
            ...
            },
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  selector: ".button-border._2",
                  selectorGuids: [
                    "d7bcd116-2c43-4f63-ad2e-e8c7e08c50cb",
                    "ee736824-73b3-06be-9a97-b265e0b26083",
                  ],
                },
                xValue: 0,
                yValue: 0,
            ...
            },
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  selector: ".button-border._3",
                  selectorGuids: [
                    "d7bcd116-2c43-4f63-ad2e-e8c7e08c50cb",
                    "52344158-1080-fa61-5278-f2532c2be960",
                  ],
                },
                xValue: 0,
                yValue: 0,
      ...
      createdOn: 1706843881951,
    },
    "a-3": {
      id: "a-3",
      title: "Donate now button IN",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "64968f24e17f17b911fe0b4b|08754793-3eb5-4bce-6e65-a77768fcc6fe",
                },
                zValue: 45,
                xUnit: "DEG",
                yUnit: "DEG",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "64968f24e17f17b911fe0b4b|08754793-3eb5-4bce-6e65-a77768fcc702",
                },
                xValue: 100,
                yValue: null,
                xUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "64968f24e17f17b911fe0b4b|08754793-3eb5-4bce-6e65-a77768fcc704",
                },
                xValue: 100,
                xUnit: "%",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "64968f24e17f17b911fe0b4b|08754793-3eb5-4bce-6e65-a77768fcc70b",
                },
                xValue: 100,
                xUnit: "%",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id: "64968f24e17f17b911fe0b4b|08754793-3eb5-4bce-6e65-a77768fcc707",
                },
                xValue: 100,
                xUnit: "%",
                yUnit: "PX",
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1707207794477,
    },
    "a-6": {
      id: "a-6",
      title: "Donate now button OUT",
      actionItemGroups: [
        {
          actionItems: [
            {
